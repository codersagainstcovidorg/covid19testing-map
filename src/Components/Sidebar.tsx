  ...
  <SearchContext.Consumer>
    {
            (searchFilters) => (
              <Drawer
                ...
                open={drawerOpen}
              >
                <div style={{ paddingTop: '135px', minWidth: '25%', maxWidth: '450px' }}>
                  <h3 style={{ color: 'black', textAlign: 'center', paddingTop: '10px' }}>Before you get started</h3>
                  <Typography style={{
                    padding: '12%', fontWeight: 'bold', fontSize: '1.3rem', color: '#E45B26', textAlign: 'center',
                  }}
                  >
                  ...
                  <FormGroup style={{
                    paddingLeft: '15%', paddingRight: '10%', paddingTop: '16px', paddingBottom: '16px',
                  }}
                  >
                    {Object.keys(searchFilters).map((filter : string, idx: number) => (
                      <FormControlLabel
                        ...
                        control={(
            <Switch
                                size="small" checked={searchFilters[filter as keyof SearchFilters]}
