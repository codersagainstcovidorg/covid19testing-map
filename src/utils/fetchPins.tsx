...
const fetchPins = async (
  ...
  distance: number = 3000,
    ...
    const endpoint = `${REACT_APP_API_ENDPOINT}/api/v1/location?limit=25000&source_latitude=${source_latitude}&source_longitude=${source_longitude}&distance=${distance}&fields=location_id,location_name,location_address_locality,location_address_region,location_latitude,location_longitude,location_status`;
